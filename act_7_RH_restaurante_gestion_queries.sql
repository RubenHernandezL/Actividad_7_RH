...
('Juan', '123456789', 'cliente1@example.com', 1),
('María', '987654321', 'cliente2@example.com', 1),
('Carlos', '456789123', 'cliente3@example.com', 1),
('Ana', '789123456', 'cliente4@example.com', 1),
('Luis', '234567890', 'cliente5@example.com', 1),
('Laura', '654321987', 'cliente6@example.com', 1),
('Pedro', '345678912', 'cliente7@example.com', 1),
('Isabel', '567890123', 'cliente8@example.com', 1),
('Manuel', '678912345', 'cliente9@example.com', 1),
('Marta', '876543210', 'cliente10@example.com', 1),
('Rosa', '112233445', 'cliente11@example.com', 1),
('Javier', '334455667', 'cliente12@example.com', 1),
('Carmen', '556677889', 'cliente13@example.com', 1),
('Pablo', '778899001', 'cliente14@example.com', 0),
...
('La Trattoria Italiana', 'Avenida Central, Ciudad B', '987654321', 'María González', 1),
('Asador Don Carlos', 'Paseo del Sol, Ciudad C', '456789123', 'Carlos Rodríguez', 1),
('Sushi Fusion', 'Calle Sakura, Ciudad D', '789123456', 'Ana López', 1),
('La Parrillada Argentina', 'Avenida del Fuego, Ciudad E', '234567890', 'Luis Martínez', 1),
('El Bistró de la Luna', 'Calle Luna, Ciudad F', '654321987', 'Laura Sánchez', 1),
...
-- Mesas del Local 1
(1, 4, 1, '2023-09-22 13:00:00', 1, 1),
(2, 2, 0, NULL, 1, NULL),
(3, 6, 0, NULL, 1, NULL),
(4, 8, 1, '2023-09-22 14:00:00', 1, 2),

-- Mesas del Local 2
(1, 2, 1, '2023-09-22 15:00:00', 2, 4),
(2, 4, 0, NULL, 2, NULL),
(3, 6, 1, '2023-09-22 16:00:00', 2, 5),
(4, 8, 0, NULL, 2, NULL),

-- Mesas del Local 3
(1, 4, 1, '2023-09-22 17:00:00', 3, 7),
(2, 2, 0, NULL, 3, NULL),
(3, 6, 0, NULL, 3, NULL),
(4, 8, 1, '2023-09-22 18:00:00', 3, 8),

-- Mesas del Local 4
(1, 2, 0, NULL, 4, NULL),
(2, 4, 1, '2023-09-22 19:00:00', 4, 9),
(3, 6, 0, NULL, 4, NULL),
(4, 8, 1, '2023-09-22 20:00:00', 4, 10),

-- Mesas del Local 5
(1, 4, 1, '2023-09-22 21:00:00', 5, 12),
(2, 2, 0, NULL, 5, NULL),
(3, 6, 0, NULL, 5, NULL),
(4, 8, 1, '2023-09-22 22:00:00', 5, 13),

-- Mesas del Local 6
(1, 4, 1, '2023-09-22 23:00:00', 6, 15),
(2, 2, 0, NULL, 6, NULL),
(3, 6, 0, NULL, 6, NULL),
(4, 8, 1, '2023-09-22 22:00:00', 6, 3),

-- Mesas del Local 7
(1, 4, 1, '2023-09-22 21:00:00', 7, 6),
(2, 2, 0, NULL, 7, NULL),
(3, 6, 0, NULL, 7, NULL),
(4, 8, 1, '2023-09-22 20:00:00', 7, 11);
