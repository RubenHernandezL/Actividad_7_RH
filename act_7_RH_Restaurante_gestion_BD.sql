...
CREATE TABLE `cliente` (
  ...
  `email` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Email: este campo debe recibir una serie de caracteres como letras, números, caracteres especiales, etc… Por dicho motivo se establece como un varchar 50, ya que se han visto casos de mail extremadamente largos y con esto quedarían cubiertos.\nPor otra parte, el mail es único, dentro de la tabla cliente, solo un cliente podrá poseer un mail específico, no se podrían repetir, ya que es información relacionada a la persona.',
...
INSERT INTO `cliente` VALUES (1,'Juan','123456789','cliente1@example.com',0),(2,'María','987654321','cliente2@example.com',1),(3,'Carlos','456789123','cliente3@example.com',0),(4,'Ana','789123456','cliente4@example.com',1),(5,'Luis','234567890','cliente5@example.com',0),(6,'Laura','654321987','cliente6@example.com',0),(7,'Pedro','345678912','cliente7@example.com',1),(8,'Isabel','567890123','cliente8@example.com',0),(9,'Manuel','678912345','cliente9@example.com',1),(10,'Marta','876543210','cliente10@example.com',0),(11,'Rosa','112233445','cliente11@example.com',1),(12,'Javier','334455667','cliente12@example.com',0),(13,'Carmen','556677889','cliente13@example.com',0),(14,'Pablo','778899001','cliente14@example.com',1),(15,'Patricia','990011223','cliente15@example.com',1);
...
INSERT INTO `locales` VALUES (1,'El Rincón del Sabor','Calle Principal, Ciudad A','123456789','Juan Pérez',1),(2,'La Trattoria Italiana','Avenida Central, Ciudad B','987654321','María González',0),(3,'Asador Don Carlos','Paseo del Sol, Ciudad C','456789123','Carlos Rodríguez',1),(4,'Sushi Fusion','Calle Sakura, Ciudad D','789123456','Ana López',0),(5,'La Parrillada Argentina','Avenida del Fuego, Ciudad E','234567890','Luis Martínez',1),(6,'El Bistró de la Luna','Calle Luna, Ciudad F','654321987','Laura Sánchez',0),(7,'Taste of India','Avenida Especias, Ciudad G','345678912','Pedro Fernández',1);
...
INSERT INTO `mesas` VALUES (1,'1',4,1,'2023-09-10 23:00:00',1,1),(2,'2',2,0,NULL,1,NULL),(3,'3',6,0,NULL,1,NULL),(4,'4',8,1,'2023-09-12 23:00:00',1,2),(5,'1',2,1,'2023-09-17 23:00:00',2,4),(6,'2',4,0,NULL,2,NULL),(7,'3',6,1,'2023-09-15 23:00:00',2,5),(8,'4',8,0,NULL,2,NULL),(9,'1',4,1,'2023-09-20 23:00:00',3,7),(10,'2',2,0,NULL,3,NULL),(11,'3',6,0,NULL,3,NULL),(12,'4',8,1,'2023-09-19 23:00:00',3,8),(13,'1',2,0,NULL,4,NULL),(14,'2',4,1,'2023-09-01 23:00:00',4,9),(15,'3',6,0,NULL,4,NULL),(16,'4',8,1,'2023-09-03 23:00:00',4,10),(17,'1',4,1,'2023-09-04 23:00:00',5,12),(18,'2',2,0,NULL,5,NULL),(19,'3',6,0,NULL,5,NULL),(20,'4',8,1,'2023-09-18 23:00:00',5,13),(21,'1',4,1,'2023-09-22 23:00:00',6,15),(22,'2',2,0,NULL,6,NULL),(23,'3',6,0,NULL,6,NULL),(24,'4',8,1,'2023-09-21 23:00:00',6,1),(25,'1',4,1,'2023-09-21 23:00:00',7,12),(26,'2',2,0,NULL,7,NULL),(27,'3',6,0,NULL,7,NULL),(28,'4',8,1,'2023-09-05 23:00:00',7,2);
...
-- Dump completed on 2023-09-24  3:51:45
